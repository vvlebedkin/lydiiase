...
class ControllerExtensionModuleBrainyFilter extends Controller
{
    ...
    private $default = [
        'basic' => [
            ...
            'style'              => [
                'block_header_background'        => ['val' => '#f7f7f7'],
                'block_header_text'              => ['val' => '#000000'],
                'product_quantity_background'    => ['val' => '#F46234'],
                'product_quantity_text'          => ['val' => '#ffffff'],
                'price_slider_background'        => ['val' => '#eeeeee'],
                'price_slider_area_background'   => ['val' => '#f6a828'],
                'price_slider_border'            => ['val' => '#dddddd'],
                'price_slider_handle_background' => ['val' => '#f6f6f6'],
                'price_slider_handle_border'     => ['val' => '#cccccc'],
                'group_block_header_background'  => ['val' => '#CECBCB'],
                'group_block_header_text'        => ['val' => '#000000'],
                'resp_show_btn_color'            => ['val' => '#19A3DF'],
                'resp_reset_btn_color'           => ['val' => '#F53838'],
    ...
    private $defaultLayoutSettings = [
        ...
        'behaviour'          => [
            ...
            'product_count'     => 2,
            'hide_empty'        => 2,
            'limit_items'       => ['enabled' => 2],
            'sections'          => [
                'search'       => ['enabled' => 2],
                'price'        => ['enabled' => 2],
                'category'     => ['enabled' => 2],
                'stock_status' => ['enabled' => 2],
                'manufacturer' => ['enabled' => 2],
                'attribute'    => ['enabled' => 2],
                'option'       => ['enabled' => 2],
                'filter'       => ['enabled' => 2],
                'rating'       => ['enabled' => 2],
        ...
        'submission'         => ['submit_type' => 'default'],
        'style'              => [
            'block_header_background'        => ['default' => '1'],
            'block_header_text'              => ['default' => '1'],
            'product_quantity_background'    => ['default' => '1'],
            'product_quantity_text'          => ['default' => '1'],
            'price_slider_background'        => ['default' => '1'],
            'price_slider_area_background'   => ['default' => '1'],
            'price_slider_border'            => ['default' => '1'],
            'price_slider_handle_background' => ['default' => '1'],
            'price_slider_handle_border'     => ['default' => '1'],
            'group_block_header_background'  => ['default' => '1'],
            'group_block_header_text'        => ['default' => '1'],
            'resp_show_btn_color'            => ['default' => '1'],
            'resp_reset_btn_color'           => ['default' => '1'],

            'responsive'                     => ['enabled' => 2],
        ],
        'attributes_default' => ['enable_all' => 2],
        'options_default'    => ['enable_all' => 2],
        'filters_default'    => ['enable_all' => 2],
    ];
    ...
    public function index()
    {
        ...
        $this->_data['basicSettings'] = ! $isFirstLaunch ? $this->config->get('brainyfilter_layout_basic') : [];

        $modSettings = $settings[$moduleId === 'new' ? 'basic' : $moduleId];

        $this->_data['filterBlocks'] = [];
...
//        }
    ...
    protected function _adjustSettingsForTheme($settings)
    {
        ...
        if (preg_match('/^default/i', (string) $theme)) {
            $set = [
                'containerSelector' => '#content .row:nth-last-of-type(2)',
                'paginatorSelector' => '#content .row:nth-last-of-type(1)',
            ];
        } elseif (preg_match('/^journal/i', (string) $theme)) {
            $set = [
                'containerSelector' => '.main-products.product-list, .main-products.product-grid',
                'paginatorSelector' => '.pagination',
            ];
        } elseif (preg_match('/^shoppica/i', (string) $theme)) {
            $set = [
                'containerSelector' => '#listing_options + .clear + .s_listing',
                'paginatorSelector' => '.pagination',
            ];
        } elseif (preg_match('/^sellegance/i', (string) $theme)) {
            $set = [
                'containerSelector' => '.product-filter + .row',
                'paginatorSelector' => '.pagination',
            ];
        } elseif (preg_match('/^pavilion/i', (string) $theme)) {
            $set = [
