...
$_['heading_title']                         = 'Brainy Filter Ultimate'; 
$_['bf_signature']	                        = "Brainy Filter Ultimate 5.1.4 OC3. Created by <a href=\"https://oc3x.ru/\">OC3X.RU</a> &copy; 2016-" . date('Y'); 
...
$_['help_about_content']                    = '<p>Brainy Filter Ultimate 5.1.4 OC3 is a module for OpenCart for filtering products. It\'s the most thought out and nice looking extention of the kind.</p>' .'<h2>Free Support</h2>' .'<p>Our team does its best to maintain the module bug free and easy to work with. If you find a bug in the module code we will fix it free of charge. We also can install the module and make a few tweaks to your theme to make it work. Please note that this can be done only once. If you chose another theme or reinstall the system we will not be able to provide you with free support for the second time. We also do not adjust the module template to suit any custom themes better and do not add any custom features within the bounds of the free support service.</p>' .'<p>(!) If you face a problem before contacting our support team please make sure to check the FAQ &amp; Troubleshoting section. Please note that section is loaded from the Internet and is updated periodically.</p>' .'<p>The support email is <a href="mailto:other@oc3x.ru">other@oc3x.ru</a>. (!) When contacting the support please provide your OpenCart order id and the date of purchase.</p>' .'<h2>Paid Support</h2>' .'<p>Our development team has enormous experience in web development and would be happy to help with any custom features you might need. We also develop non-OpenCart projects including quite large and complicated. You can always discuss all of the details and get a quote by contacting our sales department <a href="mailto:other@oc3x.ru">other@oc3x.ru</a>.</p>';
