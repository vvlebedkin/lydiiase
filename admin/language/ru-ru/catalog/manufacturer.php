...
$_['text_keyword']           = 'Должно быть уникальным на всю систему и без пробелов.<br> Для автоматической генерации уникальных мультиязычных SEO URL рекомендуем установить <a href="https://opencart-3x.ru/seo-url-chpu-generator-dlya-openkart-3" target="_blank"> это расширение</a>.';
